  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // KPI accent colors
        kpi: {
          performance: "hsl(var(--kpi-performance))",
          quality: "hsl(var(--kpi-quality))",
          stock: "hsl(var(--kpi-stock))",
          delay: "hsl(var(--kpi-delay))",
          energy: "hsl(var(--kpi-energy))",
          maintenance: "hsl(var(--kpi-maintenance))",
        },
        sidebar: {
